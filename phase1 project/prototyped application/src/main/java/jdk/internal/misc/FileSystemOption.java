...
public class FileSystemOption {
	...
	private static void CreateFileUsingFileClass() throws IOException{
		File file=new File("C:Users\\91701\\simplilearn\\phase1 project\\prototyped application");
	...
	private static void CreateFileUsingOutputStreamClass() throws IOException{
		...
		FileOutputStream out=new FileOutputStream("C:Users\\91701\\simplilearn\\phase1 project\\prototyped application");
				out.write(data.getBytes());
				out.close();
		}
	private static void CreateFileIn_NIO() throws IOException{
		String data ="hi class is going to over";
		Files.write(Paths.get("C:Users\\91701\\simplilearn\\phase1 project\\prototyped application"),data.getBytes());
